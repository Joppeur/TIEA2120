...
window.addEventListener("load", function() {
    ...
    joukkueform.muokkaa.addEventListener("click", function(e) {
        ...
        for (let index = 0; index < muokattava_joukkue["jasenet"].length; index++) {
            let rivi = alkuperainen_joukkue["listaus"]["jasenet"].childNodes[index];
            rivi.textContent = muokattava_joukkue["jasenet"][index];
...
function addJasenInput(parent, jasenet) {
    ...
    for (let index = 0; index < n; index++) {
        ...
        if (jasenet !== null) {
            ...
            //input.henkilo = jasenet[index];
            //input.muokattava_henkilo = jasenet[index];
        } else {
            //input.henkilo = '';
            //input.muokattava_henkilo = '';
        }

        
        let lomake = document.forms[2];
        //input.addEventListener('input', muokkaaNimi);
...
// function muokkaaNimi(e) {
//     let henkilo = e.currentTarget.henkilo;
//     let lomake = document.getElementById('joukkuelomake');

//     lomake.muokattava_henkilo = lomake.jasen1.value;
//     lomake.alkuperainen_henkilo = henkilo;

//     lomake.jasen1.value = lomake.muokattava_henkilo;
//     console.log('alkup: ' + lomake.alkuperainen_henkilo);
//     console.log('muokat: ' + lomake.muokattava_henkilo);
// }
...
function muokkaaJoukkue(e) {
    ...
    // oma koodi
    // let nimiInput = document.getElementById('nimi1');
    // let joukkueenNimi = e.target.textContent;
    // nimiInput.value = joukkueenNimi;
    // let joukkue = e.target.joukkueObj;
    // //let joukkue = getJoukkueByNimi(joukkueenNimi);
    // console.log(joukkue.jasenet);


    // //let fieldset = generateFieldset(document.querySelector("#joukkuefieldset > p:nth-child(2)"));
    // let fieldset = document.getElementById('jasenet');
    ...
    // // tallennetaan viittaus aktiiviseen joukkueeseen,
    // // jota kaytetaan tallenna muutokset-napissa.
    // let form = document.forms[2];
    // form.joukkueObj = joukkue;
...
function lisaaRiviTaulukkoon(taulukko, joukkue) {
    ...
    //let joukJasenet = document.createTextNode(joukkue.jasenet.join(', '));
    ...
    // nimi.textContent = document.createTextNode(haeJasenet());
    ...
    //     jasen.
    //     let jasenText = document.createTextNode(jasen + ", ");
    //     nimi1.appendChild(jasenText);
    // }
    //nimi1.appendChild(document.createTextNode(joukJasenet.join(', ')));
